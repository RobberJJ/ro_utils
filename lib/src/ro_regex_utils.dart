...
bool roRegexIsMobileExact(String input) => RoRegexUtils.isMobileExact(input);

/// Return whether input matches regex of telephone number.
bool roRegexIsTel(String input) => RoRegexUtils.isTel(input);

/// Return whether input matches regex of id card number.
bool roRegexIsIDCard(String input) => RoRegexUtils.isIDCard(input);

/// Return whether input matches regex of id card number which length is 15.
bool roRegexIsIDCard15(String input) => RoRegexUtils.isIDCard15(input);
...
bool roRegexIsURL(String input) => RoRegexUtils.isURL(input);

/// Return whether input matches regex of Chinese character.
bool roRegexIsZh(String input) => RoRegexUtils.isZh(input);

/// Return whether input matches regex of date which pattern is "yyyy-MM-dd".
bool roRegexIsDate(String input) => RoRegexUtils.isDate(input);

/// Return whether input matches regex of ip address.
bool roRegexIsIP(String input) => RoRegexUtils.isIP(input);

/// id card province dict.
const Map<String, String> roIdCardProvinceDic = {
  '11': '北京',
  '12': '天津',
  '13': '河北',
  '14': '山西',
...
class RoRegexUtils {
  ...
  static final Map<String, String> cityMap = roIdCardProvinceDic;
